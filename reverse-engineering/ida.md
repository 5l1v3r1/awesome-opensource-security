...
* [chrisps/Hexext - a plugin to improve the output of the hexrays decompiler through microcode manipulation - 仅支持IDA 7.0](https://github.com/chrisps/Hexext)
...
* [joxeankoret/diaphora - the most advanced Free and Open Source program diffing tool - 1.8K star，有详细使用文档](https://github.com/joxeankoret/diaphora)
...
* [danigargu/deREferencing - implements more user-friendly register and stack views - 可以展示字符串](https://github.com/danigargu/deREferencing)
...
* [sibears/HRAST - PoC of modifying HexRays AST](https://github.com/sibears/HRAST)
